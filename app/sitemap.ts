...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const routes = ["", "/soluciones", "/growth-lab", "/google-workspace", "/websites", "/aprende", "/research", "/ramx", "/seguros", "/nosotros", "/blog", "/contacto", "/cotizar", "/aviso-de-privacidad", "/terminos"];
