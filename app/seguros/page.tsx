...
export default function SegurosPage() {
  return (
    <>
      <section className="page-hero insurance-hero"><div className="page-hero-grid section-shell"><div className="page-hero-copy"><h1>Protege tu auto con una decisión bien explicada.</h1><p>Comparamos opciones de aseguradoras reconocidas y te acompañamos para entender coberturas, deducibles y exclusiones antes de contratar.</p><div className="hero-actions"><a className="button button--primary" href="#cotizar-seguro">Cotizar ahora <ArrowRight size={18} /></a><Link className="button button--outline" href="https://wa.me/522213759147" target="_blank">WhatsApp <MessageCircle size={18} /></Link></div></div><div className="insurance-visual"><Car /><div><span><ShieldCheck /> Coberturas claras</span><span><FileCheck2 /> Comparación acompañada</span><span><Check /> Atención personal</span></div></div></div></section>
